...
/**
 * _errtoint - converts a string to an integer
 * @s: the string to be converted
 * Return: 0 if no numbers in string, converted number else
 * -1 on error
 */
int _errtoint(char *s)
{
	int i = o;
...
/**
 * _print_dec - function prints a decimal (integer) number (base 10)
 * @input: the input
...
/**
 * convert_num - converter f8unction, a clone of itoa
 * @num: number
 * @base: base
