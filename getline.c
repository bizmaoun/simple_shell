...
/**
 * get_inputl - gets a line minus the newline
 * @info: parameter struct
 *
 * Return: bytes read
 */
ssize_t get_inputl(info_t *info)
{
	static char *buf;
...
/**
 * _getnxtline - get the next line of input from STDIN
 * @info: parameter struct
 ...
 * Return: s
 */
int _getnxtline(info_t *info, char **ptr, size_t *length)
{
 ...
 * Return: void
 */
void siginthandle(_attribute_((unused))int sig_num)
{
	_puts("\n");
	_puts("$ ");
	_putchar(BUF_FLUSH);
